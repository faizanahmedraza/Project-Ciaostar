...
@section('logo')
@if (Request::url() == 'https://ciaostar.co.uk/celebrity/artists')
...
@elseif (Request::url() == 'https://ciaostar.co.es/celebrity/artists')
...
<img id="first" class="ml-auto" src="{{asset('images/profile.png')}}" width="25px" alt="">
@elseif (Request::url() == 'https://ciaostar.co.ae/celebrity/artists')
...
<img id="first" class="ml-auto" src="{{asset('images/profile.png')}}" width="25px" alt="">
@elseif (Request::url() == 'https://ciaostar.co.al/celebrity/artists')
...
<img id="first" class="ml-auto" src="{{asset('images/profile.png')}}" width="25px" alt="">
@elseif (Request::url() == 'https://ciaostar.co.ie/celebrity/artists')
...
<img id="first" class="ml-auto" src="{{asset('images/profile.png')}}" width="25px" alt="">
@elseif (Request::url() == 'https://ciaostar.co.in/celebrity/artists')
...
<img id="first" class="ml-auto" src="{{asset('images/profile.png')}}" width="25px" alt="">
@elseif (Request::url() == 'https://ciaostar.co.fr/celebrity/artists')
...
<img id="first" class="ml-auto" src="{{asset('images/profile.png')}}" width="25px" alt="">
@elseif (Request::url() == 'http://127.0.0.1:8000/celebrity/artists')
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            ...
                            <div class="d-flex flex-column text-white mt-2">
                                ...
                                <span class="ml-5 mb-4">Artist</span>
                            </div>
                        </div>
                        @endforeach
                    </div>
