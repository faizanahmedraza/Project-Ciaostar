...
@section('logo')
@if (Request::url() == 'https://ciaostar.co.uk/celebrity/singers')
...
@elseif (Request::url() == 'https://ciaostar.co.es/celebrity/singers')
...
<img id="first" class="ml-auto" src="{{asset('images/profile.png')}}" width="25px" alt="">
@elseif (Request::url() == 'https://ciaostar.co.ae/celebrity/singers')
...
<img id="first" class="ml-auto" src="{{asset('images/profile.png')}}" width="25px" alt="">
@elseif (Request::url() == 'https://ciaostar.co.al/celebrity/singers')
...
<img id="first" class="ml-auto" src="{{asset('images/profile.png')}}" width="25px" alt="">
@elseif (Request::url() == 'https://ciaostar.co.ie/celebrity/singers')
...
<img id="first" class="ml-auto" src="{{asset('images/profile.png')}}" width="25px" alt="">
@elseif (Request::url() == 'https://ciaostar.co.in/celebrity/singers')
...
<img id="first" class="ml-auto" src="{{asset('images/profile.png')}}" width="25px" alt="">
@elseif (Request::url() == 'https://ciaostar.co.fr/celebrity/singers')
...
<img id="first" class="ml-auto" src="{{asset('images/profile.png')}}" width="25px" alt="">
@elseif (Request::url() == 'http://127.0.0.1:8000/celebrity/singers')
                    ...
                    <div class="row">
                        ...
                        <div class="col-2">
                            <a href="{{route('celebrity.details',['id' => $item->id])}}" class="text-decoration-none"><img
                                    class="inside mx-auto" src="{{asset('storage/images/'.$item->profile_img)}}"
                                    alt=""></a>
                            <div class="d-flex flex-column text-white mt-2">
                                ...
                                <span class="ml-5 mb-4">Singers</span>
                            </div>
                        </div>
                        @endforeach
                    </div>
